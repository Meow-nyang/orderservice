...
import com.playdata.orderservice.common.exception.CustomAuthenticationEntryPointer;
...
public class SecurityConfig {
    ...
    private final CustomAuthenticationEntryPointer customAuthenticationEntryPointer;
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        ...
        http.exceptionHandling(exception -> {
            exception.authenticationEntryPoint(customAuthenticationEntryPointer);
        });
